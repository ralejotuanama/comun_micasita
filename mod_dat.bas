...
Public Function PostWebservice(ByVal var1 As String, ByVal var2 As String) As String
    ...
    strParam3 = "M1c4s1t4.2020"
    strUrl = "https://inspektortest.datalaft.com:8749/WSInspektor.asmx"
    strSoapAction = "http://tempuri.org/LoadWSInspektor"
    
    strXml = "<?xml version=""1.0"" encoding=""utf-8""?>" & _
             "<soap:Envelope xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns:soap=""http://schemas.xmlsoap.org/soap/envelope/"">" & _
             "<soap:Body>" & _
             "<LoadWSInspektor xmlns=""http://tempuri.org/"">" & _
             "<Numeiden>" & var1 & "</Numeiden>" & _
             "<Nombre>" & var2 & "</Nombre>" & _
             "<Password>" & strParam3 & "</Password>" & _
             "</LoadWSInspektor>" & _
             "</soap:Body>" & _
             "</soap:Envelope>"
    ...
    End If
     ...
     'MsgBox ("se va modificar")
     'MsgBox (strRet)
     strRem = Replace(Replace(Replace(strRet, """", ""), "<?xml version=1.0 encoding=utf-8?><soap:Envelope xmlns:soap=http://schemas.xmlsoap.org/soap/envelope/ xmlns:xsi=http://www.w3.org/2001/XMLSchema-instance xmlns:xsd=http://www.w3.org/2001/XMLSchema><soap:Body><LoadWSInspektorResponse xmlns=http://tempuri.org/><LoadWSInspektorResult>", ""), "</LoadWSInspektorResult></LoadWSInspektorResponse></soap:Body></soap:Envelope>", "")
     'MsgBox (strRem)

    modgen_g_str_rptwebservice = strRem

    myPos = InStr(strRet, "No existen registros asociados")
    PostWebservice = myPos
End Function
